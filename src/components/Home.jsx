  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          ...
          <div>
            <h1 className='text-5xl sm:text-7xl font-bold flex flex-row text-[#ccd6f6]'>Emre </h1>
            <h1 className='text-5xl sm:text-7xl font-bold flex flex-row text-orange-600'>Doğramacı</h1>
          </div>
